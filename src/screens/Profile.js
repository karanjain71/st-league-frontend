...
import {Image, Center, Divider, FlatList, Box, VStack, HStack, Spacer, Avatar, Text, Stack,
...
function Profile() {
  ...
  return (
    <>
      ...
      <Divider/>
      <Text pl={5} mt={3}>Contest Details</Text>
      <Stack direction="row" mb="2" mt="6" space={3} mx="4">
          <Center size="16" bg="white" rounded="sm" _text={{
          color: "black",
          fontWeight: "medium"
        }} shadow={"3"} width={175}>
            Contests won: 2
          </Center>
          <Center bg="white" size="16" rounded="sm" _text={{
          color: "black",
          fontWeight: "medium"
        }} shadow={"3"} width={175}>
